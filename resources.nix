  {
    ...
    test =
      {
        alpha = resource : resource { file = scripts : scripts.test.log.resources.alpha.init ; salt = 60 * 02 ; } ;
        beta = resource : resource { file = scripts : scripts.test.log.resources.beta.init ; salt = 60 * 06 ; } ;
