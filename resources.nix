  {
    cron =
      {
        alpha = resource : resource { salt = scripts : scripts.structure.release.alpha ; show = false ; } ;
	beta = resource : resource { salt = scripts : scripts.structure.release.beta ; show = false ; } ;
        log =
	  {
