                                    ...
                                    in
                                      {
                                        success = _utils.visit {
                                          ...
                                          string = track : builtins.trace ( "<< ${ builtins.hashString ( builtins.toString seed ) }" ) ( builtins.replaceStrings [ ( builtins.hashString "sha512" ( builtins.toString seed ) ) ] [ "" ] track.processed == track.processed ) ;
                                          } ( scripts ( fun 0 ) ) ;
                                        value = ( fun seed ) ;
                                      }
                            ) ;
