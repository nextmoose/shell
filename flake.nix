                                    ...
                                    in
                                      {
                                        success = _utils.visit {
                                          list = track : true ;
                                          set = track : builtins.trace ( builtins.concatStringsSep " , " ( builtins.map builtins.toString ( builtins.attrValue track.reduced ) ) ) ( builtins.all ( x : x ) ( builtins.attrValues track.reduced ) ) ;
