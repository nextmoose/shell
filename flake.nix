                  ...
                  (
                    nixpkgs : at : urandom : structure-directory : scripts : resources : hook : inputs :
					  ...
					  ${ pkgs.coreutils }/bin/ln --symbolic ${ pkgs.writeShellScriptBin "script" ( _utils.strip script ) }/bin/script ${ _utils.bash-variable "LOG" }/command &&
							      ...
							      ${ pkgs.coreutils }/bin/echo 9a4e5cb1-8a21-4000-af73-9f1b41c26b2b 9533f281-c184-4253-a6b8-670914ccda34 RESOURCE_DIRECTORY=${ _utils.bash-variable "2" } >> ${ structure-directory }/afa82912-e555-46ea-b5be-a178721b367e &&
