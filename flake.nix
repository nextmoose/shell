                                    ...
                                    in
                                      {
                                        success = _utils.visit {
                                          list = track : true ;
                                          set = track : builtins.trace ( ">> ${ builtins.concatStringsSep "" ( builtins.map builtins.typeOf ( builtins.attrNames track.processed ) ) }" ) ( builtins.all ( x : x ) ( builtins.attrValues track.processed ) ) ;
