                                                        ...
                                                        let
                                                          cleanup =
                                                            ''
                                                              ...
                                                              ${ pkgs.coreutils }/bin/echo ${ pkgs.coreutils }/bin/nice --adjustments 19 ${ pkgs.writeShellScriptBin "delete-link" ( _utils.strip delete-link ) }/bin/delete-link ${ _utils.bash-variable "1" } ${ _utils.bash-variable "2" }  > >( ${ pkgs.moreutils }/bin/ts >> ${ structure-directory }/fa82912-e555-46ea-b5be-a178721b367e 2> /dev/null ) &&
                                                              ${ pkgs.coreutils }/bin/echo ${ pkgs.coreutils }/bin/nice --adjustments 19 ${ pkgs.writeShellScriptBin "delete-link" ( _utils.strip delete-link ) }/bin/delete-link ${ _utils.bash-variable "1" } ${ _utils.bash-variable "2" } | ${ at } now + ${ builtins.toString minutes }min 2> >( ${ pkgs.moreutils }/bin/ts >> ${ structure-directory }/fa82912-e555-46ea-b5be-a178721b367e 2> /dev/null )
                                                            '' ;
                                                          delete-link =
                                                            ''
