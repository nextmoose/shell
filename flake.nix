                                    ...
                                    in
                                      {
                                        success = _utils.visit {
                                          list = track : true ;
                                          set = track : builtins.trace "02 :  ${ builtins.concatStringsSep " , " ( builtins.map builtins.toString ( builtins.attrValues track.input ) ) }" ( builtins.all ( x : x ) ( builtins.attrValues track.reduced ) ) ;
