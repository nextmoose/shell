                                                            ...
                                                            unsalted =
                                                              {
                                                                show =
                                                                  let
                                                                    bool = track : if track.reduced then shell-scripts.structure._resource.cat else shell-scripts.structure._resource.echo ;
                                                                    null = track : shell-scripts.structure._resource.cat ;
                                                                    in visit { bool = bool ; null = null ; undefined = undefined ; } show ;
                                                              } ;
                                                            in invoke fun { hash = hash ; } ;
