                                                        ...
                                                        let
                                                          ...
                                                          delete-resource =
                                                            ''
                                                              ...
                                                              ${ pkgs.coreutils }/bin/echo 9a4e5cb1-8a21-4000-af73-9f1b41c26b2b 9201d245-066a-4f61-8e0b-7a5c3aad207e 1 ${ _utils.bash-variable "RESOURCE_DIRECTORY" } > >( ${ pkgs.moreutils }/bin/ts >> ${ structure-directory }/fa82912-e555-46ea-b5be-a178721b367e 2> /dev/null ) &&
