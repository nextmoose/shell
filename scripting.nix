      ...
      log =
        {
	      ...
	      ${ coreutils }/bin/echo ${ track.qualified-name } > ${ bash-variable local.variables.log-dir }/script.asc &&
	      ${ coreutils }/bin/chmod 0400 ${ bash-variable local.variables.log-dir }/script.asc
            '' ;
        } ;
      resource =
        {
          ...
          yes =
            ''
              ...
              export ${ global.variables.timestamp }=${ bash-variable "${ global.variables.timestamp }:=$( ${ coreutils }/bin/date +%s )" }
            '' ;
        } ;
      structure =
        {
      ...
      temporary =
        {
	      ...
	      ${ coreutils }/bin/chmod 0400 ${ bash-variable local.variables.temporary-dir }/script.asc &&
